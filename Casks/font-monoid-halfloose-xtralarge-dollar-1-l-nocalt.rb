cask 'font-monoid-halfloose-xtralarge-dollar-1-l-nocalt' do
  version :latest
  sha256 :no_check
  ...
  name 'Monoid-HalfLoose-XtraLarge-Dollar-1-l-NoCalt'
  homepage 'http://larsenwork.com/monoid/'

  font 'Monoid-Bold-HalfLoose-XtraLarge-Dollar-1-l-NoCalt.ttf'
  font 'Monoid-Italic-HalfLoose-XtraLarge-Dollar-1-l-NoCalt.ttf'
